    ...
    def agents(self) -> list[AgentDefinition]:
        return [
            ...
            AgentDefinition(
                ...
                responsibilities=[
                    "Extraire faits, entités, dates, montants et sources.",
            ...
            AgentDefinition(
                ...
                responsibilities=[
                    "Identifier les actions soumises à validation.",
            ...
            AgentDefinition(
                ...
                responsibilities=[
                    "Examiner contraintes techniques et dépendances.",
                    "Identifier risques d’implémentation.",
                ],
    ...
    def skills(self) -> list[SkillDefinition]:
        return [
            SkillDefinition(
                ...
                knowledge_sources=["architecture_fr_cctp_models", "architecture_fr_contract_clauses"],
                approval_required_if=[
                    ActionKind.FILE_MUTATION,
                    ActionKind.EXTERNAL_COMMUNICATION,
                    ActionKind.MEMORY_PROMOTION,
                ],
            ...
            SkillDefinition(
                ...
                knowledge_sources=["architecture_fr_dpgf_models", "architecture_fr_cctp_models"],
            ...
            SkillDefinition(
                ...
                knowledge_sources=["architecture_fr_notices"],
