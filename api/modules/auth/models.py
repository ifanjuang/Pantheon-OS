...
class User(Base):
    ...
    permissions: Mapped[list["AffairePermission"]] = relationship(back_populates="user", cascade="all, delete-orphan")
...
class AffairePermission(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "affaire_id", name="uq_affaire_permission"),)
